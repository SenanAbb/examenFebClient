<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        $url = 'http://https://blablacariw.herokuapp.com//messages/add';
        ...
        $res = file_get_contents("http://https://blablacariw.herokuapp.com//conversacion?id1=".$_GET['id_local']."&id2=".$_GET['id_ajeno']);
        $data = json_decode($res);
        $resUser = file_get_contents("http://https://blablacariw.herokuapp.com//users/edit/".$_GET['id_ajeno']);
