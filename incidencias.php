<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if ($_POST['boton'] === '1') {
            $autonomia = $_POST['qa'];
            $res = file_get_contents("http://https://blablacariw.herokuapp.com//incidencia/autonomia/".$autonomia);
            ...
            $provincia = $_POST['qp'];
            $res = file_get_contents("http://https://blablacariw.herokuapp.com//incidencia/provincia/".$provincia);
            $data = json_decode($res);
            if(isset($data->features) && !empty($data->features)) {
            ...
            $carretera = $_POST['qc'];
            $res = file_get_contents("http://https://blablacariw.herokuapp.com//incidencia/carretera/".$carretera);
            $data = json_decode($res);
            if(isset($data->features) && !empty($data->features)) {
